...
class RemoveProductFromCartTest {
    ...
    void handle_removesItemFromCart() {
        ...
        cart.setItems(List.of(new CartItem(productId, "Lune", new BigDecimal("29.90"), new ImageId("img1"), 1)));
    ...
    void handle_keepsOtherItemsIntact() {
        var cartId = new CartId("cart1");
        var productId = new ProductId("prod1");
        var otherId = new ProductId("prod2");
        var cart = cartWith(cartId);
        cart.setItems(List.of(
                new CartItem(productId, "Lune", new BigDecimal("29.90"), new ImageId("img1"), 1),
