...
import me.noynto.eosa.application.AddImageToCharm;
import me.noynto.eosa.image.Image;
import me.noynto.eosa.shared.CharmId;

public record AddImageToCharmHandler(AddImageToCharm addImageToCharm) implements Handler {
    ...
    public void handle(Context ctx) {
        ...
        try {
            ...
            addImageToCharm.handle(new AddImageToCharm.Command(
